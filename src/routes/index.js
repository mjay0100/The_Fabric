...
router.post("/register", async function (req, res) {
  ...
  // POTENTIAL SECURITY THREAT, .env files could be rendered in browser
  ...
  try {
    ...
    res.redirect("/fabrics"); // return status code 201 to show object was created
  } catch (err) {
    // not properly handled: handle request errors based on status codes
    console.log(err); // you would want to remove the console logs in production
...
router.post(
  ...
  (req, res) => {} // why do you have this here?
);
